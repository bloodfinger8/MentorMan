...
<div class="page navbar-fixed mentor_request-steps show" data-name="mentor-request-steps-show">
  <div class="page-content">
    ...
    <div class="mentor-request-block block">
        ...
        <form id="mentorapplyWriteForm" name="mentorapplyWriteForm" method="post" enctype="multipart/form-data" action="/mentor/mentorapply/mentorapplyWrite">
...
<script src="../js/mentorapply.js"></script>
<script>
