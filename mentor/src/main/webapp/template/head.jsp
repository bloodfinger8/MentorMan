	...
	<div class="navbar">
		<div class="navbar-inner">
			...
			<div class="right">
				...
				<a class="button button-big" type="external" href="/mentor/noticeboard/noticeboardList">공지 게시판</a>
				<c:if test="${memDTO!=null}">
				<a class="button button-big beta-div" type="external" href="/mentor/mentorapply/mentorapplyForm"> 멘토 지원하기 </a>
				</c:if>
				<c:if test= "${memDTO==null}">
