	...
	<div class="navbar">
		<div class="navbar-inner">
			...
			<div class="right">
				...
				<div class="beta-div">
					<a class="button button-big program-button" type="external" href="/mentor/mentee/menteeUserForm"> 멘티 <span class='beta-text'>beta</span>
					</a>
				</div>
				<a class="button button-big beta-div" type="external" href="/mentor/mentorapply/mentorapplyForm"> 멘토 지원하기 </a> <a
