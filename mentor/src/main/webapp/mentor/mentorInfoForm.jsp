	      ...
	      <h1>멘토 정보</h1>
		              ...
		              <li class="item-content item-input">
		                <div class="item-inner">
		                  <div class="item-input-wrap">
		                    <input class=" is-valid string required" placeholder="이름" type="text" value="${memDTO.member_name}" readonly="readonly" name="mentor_name" id="mentor_name">
		                  </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <input class=" is-valid string optional" placeholder="회사명" type="text" value="${mentorDTO.mentor_company}" name="mentor_company" id="mentor_company">
		                </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <input class=" is-valid string optional" placeholder="부서" type="text" value="${mentorDTO.mentor_department}" name="mentor_department" id="mentor_department">
		                </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <input class=" is-valid string optional" placeholder="직급" type="text" value="${mentorDTO.mentor_position}" name="mentor_position" id="mentor_position">
		                </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <input class=" is-valid string optional" type="text" name="mentor_school" id="mentor_school" value="${mentorDTO.mentor_school}">
		                </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <textarea class=" is-valid text optional" name="mentor_career" id="mentor_career">${mentorDTO.mentor_career}</textarea>
		                </div>
		                  <div id="mentor_career_error"></div>
		              </div>
		            </li>
		          </ul>
		          <div class="block-footer"> 예시) 현) 한국자동차 해외영업팀 과장<br>현) 직장인 와인동호회 부회장<br>전) 대한자동차 해외영업팀 대리<br></div>
		        </div>
		    ...
		    <div class="mentor-request-block block">
		                ...
		                <div class="col-33">
		                  <li>
		                    <label class="item-checkbox item-content">
		                      <input type="checkbox" name="mentoring_code" id="mentoring_code_0" class="mentoring_code" value="mentoring_code_0">
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <input class=" is-valid string optional" placeholder="대표 멘토링 가능 분야를 한 줄로 작성해주세요" type="text" name="mentor_represent" id="mentor_represent" value="${mentorDTO.mentor_represent}">
		                </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <textarea class=" is-valid text optional" name="mentor_info" id="mentor_info">${mentorDTO.mentor_info}</textarea>
		                </div>
		        ...
		        <div class="list inset no-hairlines">
		          <ul>
		            <li class="item-content item-input">
		              <div class="item-inner">
		                <div class="item-input-wrap">
		                  <textarea class="text optional" placeholder="멘토로 가입한 계기 및 회사에 대한 소개 또는 기타 하고 싶은 말을 적어주세요" name="mentor_etc" id="mentor_etc">${mentorDTO.mentor_etc}</textarea>
		                </div>
		              </div>
		            </li>
		          </ul>
			    ...
			    <div class="mentor-request-block block">
			        ...
			        <div class="list inset no-hairlines">
			          <ul>
			            <li class="item-content item-input">
			              <div class="item-inner">
			                <div class="item-input-wrap">
			                  <input class=" is-valid string email optional" readonly="readonly" value="${memDTO.member_email}" type="email" name="mentor_email" id="mentor_email">
			                </div>
				    ...
				    <div class="block">
				      <label for="mentor_request_name_card" class="button button-small button-inline">이미지 업로드</label>
				      <input class="is-valid file optional" accept=".jpg, .jpeg, .png" onchange="previewFile(this);" type="file" name="mentor_businesscard" id="mentor_request_name_card" value="${mentorDTO.mentor_businesscard}">
				      <p><img id="mentor_businesscard_img" src="../storage/${mentorDTO.mentor_email}/${mentorDTO.mentor_businesscard}" style="width: 100px; height: 100px"></p>
...
<input type="hidden" id="getMentoring_code" value="${mentorDTO.mentoring_code}">
<script src="../js/mentor.js"></script>
<script>
var mentoring = $('#getMentoring_code').val().split(',');
for(var i=0; i < mentoring.length; i++){
	$('#'+mentoring[i]).val(mentoring[i]).prop('checked', true);		
}
$('#job_code').val('${mentorDTO.job_code}').prop('selected', true);
$('#mentor_selectNaming').val('${mentorDTO.mentor_selectNaming}').prop('selected', true);

$(document).ready(function(){
	$('#mentorProfile').attr('class','list-button color-gray item-link active').css('font-weight','bold');
