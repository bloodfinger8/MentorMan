...
<input type="hidden" class="seq" value="${adminnoticeboardDTO.noticeboard_seq }">
<input type="hidden" class="pg" value="${pg }">
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel" style="height: 600px; overflow: auto;">
			<div class="x_title">
				<h2>제목 : [공지] ${adminnoticeboardDTO.noticeboard_title }</h2>
