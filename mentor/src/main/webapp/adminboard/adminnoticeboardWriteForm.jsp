		...
		<div class="x_panel" style="height: 600px;">
			...
			<form method="post" id="noticeboardWriteForm" enctype="multipart/form-data">
				<div class="table-responsive" style="overflow:hidden;">
					...
					<tr>
						<th scope="cols">
							<input type="text" id="noticeTitle" name="noticeTitle" placeholder="제목입력">
							<span id="noticeboardWriteNonTitle_error_span"></span>
						</th>
					</tr>
				 	<tr>
				 		<td colspan="2">
				...
				<div class="form-group">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<button type="button" class="btn btn-info btn-sm noticeboerdWriteForm_backBtn" >뒤로가기</button>
						<button type="button" class="btn btn-success btn-sm noticeboardWriteForm_Btn" >작성하기</button>
					</div>
				</div>
			</form>
				<div class="ln_solid"></div>
